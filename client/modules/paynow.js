...
app.post('/ecocash', async (req, res) => {
    // Create instance of Paynow class
    let paynow = new Paynow(4176, "");
...
app.post('/pay', async (req, res) => {
    ...
    const fields = {
        id: "04ab375d-861b-40b9-8ec0-d0b605a0982f", // found on the screen with final details on paynow developer
...
app.post('/pay/paynow', async (req, res) => {
    ...
    if (products.length === 0) {
        return res.status(400).json({
            message: 'You need to have at least one item in cart'
        })
    }
    console.log('alive and kicking')
    const paynow = new Paynow(4176, "");
    // Set return and result urls
    paynow.resultUrl = 'https://paynow.now.com';
    paynow.returnUrl = 'https://paynow.netlify.com';
